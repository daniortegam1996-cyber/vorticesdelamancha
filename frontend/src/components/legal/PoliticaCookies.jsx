      ...
      <div className="prose prose-lg max-w-none text-gray-700">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mt-4 space-y-2">
            ...
            <li><strong>Dirección:</strong> {DATOS_ASOCIACION.direccion}, {DATOS_ASOCIACION.codigoPostal} {DATOS_ASOCIACION.ciudad}</li>
        ...
        <section className="mb-8">
          ...
          <div className="mt-6 overflow-x-auto">
            <table className="min-w-full border border-gray-300">
              ...
              <tbody>
                <tr>
                  <td className="border border-gray-300 px-4 py-2">cookies_accepted</td>
        ...
        <section className="mb-8">
          ...
          <p>{DATOS_ASOCIACION.nombre} puede modificar esta Política de Cookies en función de cambios legislativos, regulatorios o con la finalidad de adaptar dicha política a las instrucciones dictadas por la Agencia Española de Protección de Datos.</p>
        ...
        <section className="mt-12 p-6 bg-gray-100 rounded-xl">
          <p className="text-sm text-gray-600">
            <strong>Contacto:</strong> Para cualquier consulta sobre nuestra Política de Cookies, puede contactarnos en <a href={`mailto:${DATOS_ASOCIACION.email}`} className="text-[#0074D9] hover:underline">{DATOS_ASOCIACION.email}</a>
          </p>
        </section>
      </div>
    </LegalLayout>
